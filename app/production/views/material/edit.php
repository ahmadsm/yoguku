  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a href="<?php echo base_url('material/index'); ?>" class="btn btn-sm btn-flat bg-red pull-right">Back</a>
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <form method="post" action="<?php echo base_url('material/update') ?>" class="form-horizontal">
            <div class="form-group">
              <label class="col-sm-3 control-label">Material Code</label>
              <div class="col-sm-4">
                <input type="hidden" name="id" class="form-control" required="" placeholder="Your answer" value="<?php echo $this->uri->segment(3); ?>">
                <input type="text" name="kode" class="form-control" required="" placeholder="Your answer">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Material Unit</label>
              <div class="col-sm-4">
                <input type="text" name="satuan" class="form-control" required="" placeholder="Your answer">
              </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
  ...
  $.ajax({
    type: "post",
    url: "<?php echo base_url(); ?>material/show",
    data: {"id":id},
    success: function(res) {
      var obj = JSON.parse(res);
      $('input[name="kode"]').val(obj.kode);
      $('input[name="nama"]').val(obj.nama);
      $('input[name="satuan"]').val(obj.satuan);
    }
  });
</script>
