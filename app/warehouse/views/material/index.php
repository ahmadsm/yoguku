            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <a href="<?php echo base_url('material/create'); ?>" class="btn btn-sm btn-flat bg-red pull-right">Create New</a>
                        <a href="<?php echo base_url('material/sync'); ?>" class="btn btn-sm btn-flat bg-green pull-right">Sync</a>
                    </h1>
                </section>
                                    ...
                                    if ($material != "") {
                                        ...
                                        foreach ($material as $key) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $key['kode']; ?></td>
                                                ...
                                                <td style="vertical-align: middle;"><?php echo $key['last_update']; ?></td>
