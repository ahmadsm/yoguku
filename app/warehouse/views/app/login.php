...
<head>
  ...
  <title>Yoguku | Control Panel</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>component/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="javascript:void(0);"><b>Yoguku</b>Warehouse</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?php echo base_url(); ?>component/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
