            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <a href="<?php echo base_url('supply/create'); ?>" class="btn btn-sm btn-flat bg-red pull-right">Create New</a>
                    </h1>
                </section>
                                ...
                                <tbody>
                                    ...
                                    foreach ($supply as $key) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;"><?php echo $key->qty . ' ' . $key->satuan; ?></td>
                                            <td style="vertical-align: middle;"><?php echo $key->transaction_date; ?></td>
                                            <td style="vertical-align: middle;">
                                                <a href="<?php echo base_url('supply/edit/' . $key->id); ?>" class="btn btn-flat bg-aqua btn-sm"><i class="fa fa-gear"></i></a>
                                                <a href="<?php echo base_url('supply/delete/' . $key->id); ?>" class="btn btn-flat bg-red btn-sm"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $no++;
