  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <a href="<?php echo base_url('demand/index'); ?>" class="btn btn-sm btn-flat bg-red pull-right">Back</a>
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <form method="post" action="<?php echo base_url('demand/store') ?>" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" name="qty" class="form-control" required="" placeholder="Your answer">
              </div>
            </div>
            <div class="form-group">
